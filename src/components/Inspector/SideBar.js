                ...
                <ul className="nav nav-pills flex-column mb-sm-auto mb-0 align-items-center align-items-sm-start" id="menu">
                    ...
                    <li className="nav-item">
                        <Link to="/inspector/content-managament" className="nav-link align-middle px-0">
                            <i className="fs-4 bi bi-list-task"></i> <span className="ms-1 d-none d-sm-inline">Задания</span>
                        </Link>
                    </li>

                    <li className="nav-item">
                        <Link to="/inspector/courses-managament" className="nav-link align-middle px-0">
                            <i className="fs-4 bi bi-bar-chart-steps"></i> <span className="ms-1 d-none d-sm-inline">Курсы</span>
                        </Link>
                    </li>
                </ul>
