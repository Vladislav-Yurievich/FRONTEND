...
import CoursesManagament from './components/Inspector/CoursesManagament';



import Demka from './pages/Demka';
      ...
      <BrowserRouter>
        ...
        <Routes>
          ...
          <Route element={<PrivateRoute />}>
            ...
            <Route path='/inspector/courses-managament' element={<CoursesManagament />} />
          ...
          <Route path='producer/demka' element={<Demka />} />
